;var json_locale_data = {
   "messages": {
      ...
      "Our app is powered by the latest and most advanced protocols like: Wireguard, PPTP, OpenVPN and L2TP/IPSec.": [
         null,
         "La nostra app include i protocolli più recenti e avanzati come: Wireguard, PPTP, OpenVPN e L2TP/IPSec."
      ],
      ...
      "<p><b class='text-uppercase'>\"Private Internet Access</b></p><p>out-performs and out-features the competition\"</p>": [
         null,
         "<p><b class='text-uppercase'>\"Private Internet Access</b></p><p>presenta prestazioni e funzionalità migliori rispetto alla concorrenza.\"</p>"
      ],
      ...
      "Private Internet Access has a no questions asked %s day money back guarantee. Subscribe to Private Internet Access today to start streaming now!": [
         null,
         "Con Private Internet Access hai una garanzia di rimborso di %s giorni, e non sei tenuto a dare spiegazioni. Abbonati a Private Internet Access oggi stesso e inizia subito con lo streaming!"
      ],
      ...
      "Save <b>%s%</b><br><span class=\"lines\">& get <b>%s extra months <span>free</span></b></span>": [
         null,
         "Risparmia <b>%s%</b><br><span class=\"lines\">e ottieni <b>%s mesi extra <span>gratis</span></b></span>"
      ],
      "Save <b>%s%</b> & get<br><b class=\"lines\">%s extra months</b><br><span>free</span>": [
         null,
         "Risparmia <b>%s%</b> e ottieni<br><b class=\"lines\">%s mesi extra</b><br><span>gratis</span>"
      ],
      "Save <b>%s%</b><br>& get<br><b class=\"lines\">%s extra months</b><br><span>free</span>": [
         null,
         "Risparmia <b>%s%</b><br>e ottieni<br><b class=\"lines\">%s mesi extra</b><br><span>gratis</span>"
      ],
      "for only <b class=\"mx-md-3 mx-2\"><span>%s</span><span>%s</span></b> /month": [
         null,
         "a soli <b class=\"mx-md-3 mx-2\"><span>%s</span><span>%s</span></b> /mese"
      ],
      "The VPN recommended by<br><b>%s</b>": [
         null,
         "La VPN raccomandata da<br><b>%s</b>"
      ],
      "Save %s% Now": [
         null,
         "Risparmia ora %s%"
      ...
      "Sign-up now & get %s extra months <span class='text-uppercase'>free</span>": [
         null,
         "Registrati ora e ottieni %s mesi extra <span class='text-uppercase'>gratis</span>"
      ],
      ...
      "Using <span>Zoom</span> for video calls?": [
         null,
         "Usi <span>Zoom</span> per le videochiamate?"
      ],
      "Make sure your online activity stays hidden": [
         null,
         "Assicurati che ciò che fai online rimanga segreto"
      ],
      "Why use a VPN with Zoom?": [
         null,
         "Perché utilizzare una VPN con Zoom?"
      ],
      "Zoom has been accused of sharing user data with Facebook, they lied about the app having end-to-end encryption, and the app allowed meeting hosts to track attendees.<br><br><b>So get Private Internet Access to encrypt your data, hide your IP address and become anonymous while using Zoom.</b>": [
         null,
         "Zoom è stata accusata di condividere i dati degli utenti con Facebook, ha mentito riguardo al fatto di essere dotata di crittografia end-to-end e ha permesso che gli host delle riunioni tenessero traccia dei partecipanti.<br><br><b>Quindi, utilizza Private Internet Access per cifrare i tuoi dati, nascondere il tuo indirizzo IP e diventare anonimo mentre usi Zoom.</b>"
      ],
      "First-rate VPN service:": [
         null,
         "Servizio VPN eccellente:"
      ],
      "Bypass censorship and unblock streaming content and sites you don't have access to. Discover geo-restricted content on platforms like Netflix, HBO GO, Amazon Prime, Disney Plus, and more.": [
         null,
         "Aggira la censura e sblocca i contenuti streaming e i siti a cui non hai accesso. Scopri contenuti con restrizioni geografiche su piattaforme come Netflix, HBO GO, Amazon Prime, Disney Plus e non solo."
      ],
      ...
      "Private Internet Access provides the highest speeds possible. So, you can have calls without any buffering or connectivity issues.": [
         null,
         "Private Internet Access offre la massima velocità possibile per chiamate senza buffering o problemi di connettività."
      ],
      "Unbreakable Encryption": [
         null,
         "Crittografia invalicabile"
      ],
      "Encrypt your data to make sure nobody can hack your connection and get access to your data.": [
         null,
         "Cifra i tuoi dati per assicurarti che nessuno possa accedervi hackerando la connessione."
      ],
      "Become Anonymous": [
         null,
         "Diventa anonimo"
      ...
      "Browse anonymously with a private IP address and protect yourself from your companies that want to get their hands on your data.": [
         null,
         "Naviga in forma anonima con un indirizzo IP privato e proteggiti dalle aziende che vogliono mettere le mani sui tuoi dati."
      ],
      "Connect in 4 easy steps:": [
         null,
         "Connettiti in 4 semplici passi:"
      ],
      "<b>Turn on</b><br>Private Internet Access and connect": [
         null,
         "<b>Attiva</b><br>Private Internet Access e connettiti"
      ],
      "You’re ready to start using <span>Private Internet Access</span> with zoom": [
         null,
         "Sei pronto a usare <span>Private Internet Access</span> con Zoom"
      ],
      "Use PIA on up to %s devices simultaneously": [
         null,
         "Usa PIA su massimo %s dispositivi contemporaneamente"
      ],
      "%s-Day money back guarantee": [
         null,
         "Rimborso garantito entro %s giorni"
      ],
      "<span class=\"color_pia_green\">Frequently asked questions</span>": [
         null,
         "<span class=\"color_pia_green\">Domande frequenti (FAQ)</span>"
      ],
      "How to use Private Internet Access with Zoom?": [
         null,
         "Come si fa a usare Private Internet Access con Zoom?"
      ],
      "First download and install the Private Internet Access app on the device you're planning to use for your Zoom call. Then create and verify your account. Sing-in to the PIA app using your username and password and connect to a server by clicking or tapping the big, round power button. You're now completely anonymous and protected, all that's left to do is to fire-up your Zoom app and join your conference.": [
         null,
         "Prima scarichi e installi l'app Private Internet Access sul dispositivo che intendi utilizzare per la chiamata Zoom. Poi crei e verifichi il tuo account. Accedi all'app PIA con nome utente e password e ti connetti a un server cliccando o toccando il grande pulsante rotondo di avvio. Da quel momento in poi sarai completamente anonimo e protetto. Ora ti rimane solo da aprire l'app Zoom e unirti alla chiamata."
      ],
      "Private Internet Access has a no questions asked %s-day money back guarantee. Subscribe to Private Internet Access today to start streaming now!": [
         null,
         "Con Private Internet Access hai una garanzia di rimborso di %s giorni, e non sei tenuto a dare spiegazioni. Abbonati a Private Internet Access oggi stesso e inizia subito con lo streaming!"
      ...
      "Is it safe to use Private Internet Access?": [
         null,
         "È sicuro usare Private Internet Access?"
      ],
      "Yes. Private Internet Access provides a VPN service with servers in %s locations across %s countries, including the United States, United Kingdom, Japan, and more. Private Internet access never records any of its users' data. We follow a strict no-logs policy that ensures we never keep any logs of our users' activities online.": [
         null,
         "Sì. Private Internet Access offre un servizio VPN con server in %s località in %s paesi, tra cui Stati Uniti, Regno Unito, Giappone e tanti altri. Private Internet Access non registra mai alcun dato dei suoi utenti. Ci atteniamo a una rigorosa politica No Log che garantisce che nessun registro delle attività online dei nostri utenti verrà mai conservato."
      ],
      "Will my IP address be exposed while using Zoom?": [
         null,
         "Il mio indirizzo IP sarà esposto mentre utilizzo Zoom?"
      ],
      "No. By using Private Internet Access, you are encrypting your traffic through our VPN tunnel which accesses the internet from one of our servers’ IP addresses. Streaming services, apps and websites will only see our Private Internet Access IP address, not your device’s IP address.": [
         null,
         "No. Con Private Internet Access stai crittografando il tuo traffico tramite il nostro tunnel VPN, che accede a Internet con uno degli indirizzi IP dei nostri server. I servizi di streaming, le app e i siti web vedranno solo l'indirizzo IP di Private Internet Access, e non quello del tuo dispositivo."
      ],
      ...
      "Unblock <span>new streaming content</span><br><small>on your <span>Fire Stick TV</span></small>": [
         null,
         "Sblocca <span>nuovi contenuti streaming</span><br><small>sul tuo <span>Fire TV Stick</span></small>"
      ],
      "with Private Internet Access VPN": [
         null,
         "con la VPN Private Internet Access"
      ],
      "Tired of watching the same shows and movies on streaming platforms?": [
         null,
         "Stanco di guardare sempre gli stessi programmi e film sulle piattaforme di streaming?"
      ],
      "Private Internet Access changes your IP address to one from a different location so you can discover new streaming properties.<br><b>Sign up to Private Internet Access today and unblock tons of new content from different countries around the world.</b>": [
         null,
         "Private Internet Access scambia il tuo indirizzo IP con quello di un'altra località, così potrai scoprire nuove possibilità di streaming.<br><b>Registrati oggi stesso a Private Internet Access e sblocca tantissimi nuovi contenuti di diversi paesi in tutto il mondo.</b>"
      ],
      "Stream new content on your Fire Stick TV:": [
         null,
         "Guarda nuovi contenuti streaming sul tuo Fire TV Stick:"
      ],
      "A must have for your Fire Stick TV": [
         null,
         "Un \"must\" per il tuo Fire TV Stick"
      ],
      "Access content from all over the world": [
         null,
         "Accedi ai contenuti da tutto il mondo"
      ],
      "Private Internet Access has thousands of servers in over %s countries world-wide. Connect to either one of them and discover new films, TV shows and documentaries.": [
         null,
         "Private Internet Access ha migliaia di server in oltre %s paesi in tutto il mondo. Connettiti a uno di essi e scopri nuovi film, programmi TV e documentari."
      ],
      ...
      "Connect to a server from a different country with just one click, straight from the Private Internet Access app, and unblock content that's not available in your country.": [
         null,
         "Connettiti a un server di un altro paese con un solo clic, direttamente dall'app di Private Internet Access, e sblocca contenuti che non sono disponibili nel tuo paese."
      ],
      "With just 1 Private Internet Access VPN subscription you can use the app on up to %s devices at the same time. This way you can unblock content on anything that has a screen and an internet connection.": [
         null,
         "Con solo un abbonamento alla VPN Private Internet Access, puoi usare l'app su un massimo di %s dispositivi contemporaneamente. In questo modo puoi sbloccare contenuti su qualsiasi dispositivo dotato di schermo e connessione Internet."
      ],
      ...
      "Watch your favorite movies and shows in minutes": [
         null,
         "Guarda i tuoi film e programmi preferiti in questione di minuti"
      ],
      "Got questions about streaming? <span class=\"color_pia_green\">Here are a few of our FAQs</span>": [
         null,
         "Hai domande sullo streaming? <span class=\"color_pia_green\">Ecco alcune domande frequenti</span>"
      ],
