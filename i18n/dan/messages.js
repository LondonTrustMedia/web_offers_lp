;var json_locale_data = {
   "messages": {
      ...
      "Yes. Private Internet Access provides a VPN service with servers in %s locations across %s countries, including the United States, United Kingdom, Japan, and more. The better question is: Is it safe to stream without Private Internet Access?": [
         null,
         "Ja. Private Internet Access tilbyder en VPN-tjeneste med servere placeret %s forskellige steder i %s lande, herunder USA, Storbritannien, Japan og mange flere. Det rigtige spørgsmål er: Er det sikkert at streame uden Private Internet Access?"
      ],
